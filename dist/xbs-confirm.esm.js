...
var __vue_render__ = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "xbs-dialog-container",
...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-ae68795c_0", { source: ".t-xbs-fade-enter-active,\n.t-xbs-fade-leave-active {\n  opacity: 1;\n  transition: opacity linear 0.2s;\n}\n.t-xbs-fade-enter,\n.t-xbs-fade-leave-to {\n  opacity: 0;\n}\n.a-xbs-dialog-enter-active {\n  animation: xbs-dialog-in 0.5s;\n}\n.a-xbs-dialog-leave-active {\n  animation: xbs-dialog-out 0.3s;\n}\n@keyframes xbs-dialog-in {\n0% {\n    transform: scale(1.185);\n}\n100% {\n    transform: scale(1);\n    opacity: 1;\n}\n}\n@keyframes xbs-dialog-out {\n0% {\n    transform: scale(1);\n    opacity: 1;\n}\n100% {\n    transform: scale(0.85);\n    opacity: 0;\n}\n}\n.xbs-mask-enter,\n.xbs-mask-leave-active {\n  opacity: 0;\n}\n.xbs-mask-leave-active,\n.xbs-mask-enter-active {\n  transition: opacity 300ms;\n}\n.xbs-dialog-absolute .xbs-dialog {\n  position: absolute;\n}\n", map: {"version":3,"sources":["xbs-dialog.vue"],"names":[],"mappings":"AAAA;;EAEE,UAAU;EACV,+BAA+B;AACjC;AACA;;EAEE,UAAU;AACZ;AACA;EACE,6BAA6B;AAC/B;AACA;EACE,8BAA8B;AAChC;AACA;AACE;IACE,uBAAuB;AACzB;AACA;IACE,mBAAmB;IACnB,UAAU;AACZ;AACF;AACA;AACE;IACE,mBAAmB;IACnB,UAAU;AACZ;AACA;IACE,sBAAsB;IACtB,UAAU;AACZ;AACF;AACA;;EAEE,UAAU;AACZ;AACA;;EAEE,yBAAyB;AAC3B;AACA;EACE,kBAAkB;AACpB","file":"xbs-dialog.vue","sourcesContent":[".t-xbs-fade-enter-active,\n.t-xbs-fade-leave-active {\n  opacity: 1;\n  transition: opacity linear 0.2s;\n}\n.t-xbs-fade-enter,\n.t-xbs-fade-leave-to {\n  opacity: 0;\n}\n.a-xbs-dialog-enter-active {\n  animation: xbs-dialog-in 0.5s;\n}\n.a-xbs-dialog-leave-active {\n  animation: xbs-dialog-out 0.3s;\n}\n@keyframes xbs-dialog-in {\n  0% {\n    transform: scale(1.185);\n  }\n  100% {\n    transform: scale(1);\n    opacity: 1;\n  }\n}\n@keyframes xbs-dialog-out {\n  0% {\n    transform: scale(1);\n    opacity: 1;\n  }\n  100% {\n    transform: scale(0.85);\n    opacity: 0;\n  }\n}\n.xbs-mask-enter,\n.xbs-mask-leave-active {\n  opacity: 0;\n}\n.xbs-mask-leave-active,\n.xbs-mask-enter-active {\n  transition: opacity 300ms;\n}\n.xbs-dialog-absolute .xbs-dialog {\n  position: absolute;\n}\n"]}, media: undefined });
